...
import 'package:flutter_clean_architecture/features/blog/domain/usecases/get_all_blogs.dart';
import 'package:flutter_clean_architecture/features/blog/domain/usecases/upload_blog.dart';
...
class BlogBloc extends Bloc<BlogEvent, BlogState> {
  ...
  void _onBlogUpload(BlogUpload event, Emitter<BlogState> emit) async {
    ...
    result.fold(
      (failure) => emit(
        BlogFailure(message: failure.message),
      ),
      (right) => BlogUploadSuccess(),
    );
  }
